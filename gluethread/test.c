/*
 * Created on Tue Jan 07 2020:16:56:02
...
int
senior_citizen(void *p_1, void *p_2)
{
        person_t *p1 = (person_t *)p_1;
        person_t *p2 = (person_t *)p_2;
        if (p1->age == p2->age)
                return 0;
        if (p1->age < p2->age)
                return 1;
...
main(int argc, char **argv)
{
        ...
        glthread_priority_insert(&base_glthread, &person[4].glthread,
                                 senior_citizen, offset(person_t, glthread));
        glthread_priority_insert(&base_glthread, &person[3].glthread,
                                 senior_citizen, offset(person_t, glthread));
        glthread_priority_insert(&base_glthread, &person[2].glthread,
                                 senior_citizen, offset(person_t, glthread));
        glthread_priority_insert(&base_glthread, &person[1].glthread,
                                 senior_citizen, offset(person_t, glthread));
        glthread_priority_insert(&base_glthread, &person[0].glthread,
                                 senior_citizen, offset(person_t, glthread));
